...
import { SupplierClients } from './components/cms/SupplierClients';
...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case 'suppliers': return <SupplierClients initialItemId={navItemId} onItemOpened={() => setNavItemId(undefined)} />;
